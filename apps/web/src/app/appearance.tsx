...
function applyAppearanceToDocument(appearance: AppearanceSettings) {
  ...
  document.documentElement.style.setProperty(
    "--accent-soft",
    withAlpha(activeHighlight, "26"),
  );
  document.documentElement.style.setProperty(
    "--accent-06",
    withAlpha(activeHighlight, "0f"),
  );
  document.documentElement.style.setProperty(
    "--accent-10",
    withAlpha(activeHighlight, "1a"),
  );
  document.documentElement.style.setProperty(
    "--accent-14",
    withAlpha(activeHighlight, "24"),
  );
  document.documentElement.style.setProperty(
    "--accent-18",
    withAlpha(activeHighlight, "2e"),
  );
  document.documentElement.style.setProperty(
    "--accent-24",
    withAlpha(activeHighlight, "3d"),
  );
  document.documentElement.style.setProperty(
    "--accent-32",
    withAlpha(activeHighlight, "52"),
  );
...
export function appearanceStyleClass(
