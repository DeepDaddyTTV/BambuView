...
What BambuView `0.0.40` alpha includes:
...
- BambuView Companion pairing, Companion connection tests, LAN printer discovery, cached capability reporting, direct local command or upload handoff, cached local printer visibility, importable Companion stream sources, and in-app update checks
...
- Broader native video restream coverage for printer families that still need a browser-safe bridge path
